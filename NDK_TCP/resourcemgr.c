...
#include <fw/classify1_bin.c>
#include <fw/classify2_bin.c>
#include <fw/pam_bin.c>
...
// 设备具体 QMSS 配置初始化程序
#include "device/qmss_device.c"

// 设备具体 CPPI 配置初始化程序
#include "device/cppi_device.c"
